...
const Header = () => {
  return (
    <div className='flex flex-col justify-center items-center text-center my-20'>
        ...
        <h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[595px] mx-auto mt-10 text-center'>Turn Text To <span className='text-blue-600'>Image</span>, in Seconds.</h1>
